...
import { ChatCompletionCreateParamsStreaming, createStream, ChatMessage, ChatRole } from '../agents/chatCompletion';
...
export async function nameAndSaveAs() {
	...
	const stream = await createStream(
		...
		{ "temperature": Number.EPSILON, "response_format": { "type": "json_object" } } as ChatCompletionCreateParamsStreaming
	);
	let json = "";
